...
interface IUserTaskServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  add: grpc.MethodDefinition<offline_usertask_pb.AddUserTaskRequest, common_common_entity_pb.StringListEntity>;
...
export class UserTaskServiceClient extends grpc.Client {
  ...
  add(argument: offline_usertask_pb.AddUserTaskRequest, callback: grpc.requestCallback<common_common_entity_pb.StringListEntity>): grpc.ClientUnaryCall;
  add(argument: offline_usertask_pb.AddUserTaskRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<common_common_entity_pb.StringListEntity>): grpc.ClientUnaryCall;
  add(argument: offline_usertask_pb.AddUserTaskRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<common_common_entity_pb.StringListEntity>): grpc.ClientUnaryCall;
