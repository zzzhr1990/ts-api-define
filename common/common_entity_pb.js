...
goog.exportSymbol('proto.services.BatchTaskResult', null, global);
...
goog.exportSymbol('proto.services.Int64ListEntity', null, global);
 ...
 * @constructor
 */
proto.services.Int64ListEntity = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.services.Int64ListEntity.repeatedFields_, null);
};
goog.inherits(proto.services.Int64ListEntity, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.Int64ListEntity.displayName = 'proto.services.Int64ListEntity';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.services.BatchTaskResult = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.services.BatchTaskResult, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.BatchTaskResult.displayName = 'proto.services.BatchTaskResult';
}
 ...
 * @const
 */
proto.services.Int64ListEntity.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.services.Int64ListEntity.prototype.toObject = function(opt_includeInstance) {
  return proto.services.Int64ListEntity.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.Int64ListEntity} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.Int64ListEntity.toObject = function(includeInstance, msg) {
  var f, obj = {
    dataList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.Int64ListEntity}
 */
proto.services.Int64ListEntity.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.Int64ListEntity;
  return proto.services.Int64ListEntity.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.Int64ListEntity} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.Int64ListEntity}
 */
proto.services.Int64ListEntity.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.Int64ListEntity.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.Int64ListEntity.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.Int64ListEntity} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.Int64ListEntity.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDataList();
  if (f.length > 0) {
 ...
 * @return {!Array<number>}
 */
proto.services.Int64ListEntity.prototype.getDataList = function() {
  return /** @type {!Array<number>} */ (jspb.Message.getRepeatedField(this, 1));
};
...
/**
 * @param {!Array<number>} value
 * @return {!proto.services.Int64ListEntity} returns this
 */
proto.services.Int64ListEntity.prototype.setDataList = function(value) {
  return jspb.Message.setField(this, 1, value || []);
};
 ...
 * @return {!proto.services.Int64ListEntity} returns this
 */
proto.services.Int64ListEntity.prototype.addData = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};
 ...
 * @return {!proto.services.Int64ListEntity} returns this
 */
proto.services.Int64ListEntity.prototype.clearDataList = function() {
  return this.setDataList([]);
};
 ...
 * @return {!Object}
 */
proto.services.BatchTaskResult.prototype.toObject = function(opt_includeInstance) {
  return proto.services.BatchTaskResult.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.BatchTaskResult} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.BatchTaskResult.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.BatchTaskResult}
 */
proto.services.BatchTaskResult.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.BatchTaskResult;
  return proto.services.BatchTaskResult.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.BatchTaskResult} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.BatchTaskResult}
 */
proto.services.BatchTaskResult.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.BatchTaskResult.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.BatchTaskResult.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.BatchTaskResult} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.BatchTaskResult.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.services.BatchTaskResult.prototype.getIdentity = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.services.BatchTaskResult} returns this
 */
proto.services.BatchTaskResult.prototype.setIdentity = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.services.BatchTaskResult.prototype.getData = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.services.BatchTaskResult} returns this
 */
proto.services.BatchTaskResult.prototype.setData = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.services.BatchTaskResult.prototype.getAsync = function() {
 ...
 * @return {!proto.services.BatchTaskResult} returns this
 */
proto.services.BatchTaskResult.prototype.setAsync = function(value) {
