...
export class VideoExt extends jspb.Message {
  ...
  setMaxpreviewwidth(value: number): void;

  getMaxpreviewheight(): number;
  setMaxpreviewheight(value: number): void;

  clearPreviewimagekeyList(): void;
  getPreviewimagekeyList(): Array<string>;
  setPreviewimagekeyList(value: Array<string>): void;
  ...
  setPreviewpid(value: string): void;

  getPreviewplaykey(): string;
  setPreviewplaykey(value: string): void;
