...
proto.services.WcsUploadToken.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    partUploadUrl: jspb.Message.getFieldWithDefault(msg, 2, ""),
    directUploadUrl: jspb.Message.getFieldWithDefault(msg, 3, "")
  };
...
/**
 * optional string part_upload_url = 2;
 * @return {string}
 */
...
/**
 * optional string direct_upload_url = 3;
 * @return {string}
 */
